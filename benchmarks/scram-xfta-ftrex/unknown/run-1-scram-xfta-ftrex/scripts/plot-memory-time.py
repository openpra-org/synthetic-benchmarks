...
ax1.set_xlabel('Input models', fontsize=12,  weight='bold')
ax1.set_ylabel('CPU Time [sec]', fontsize=12,  weight='bold')
...
ax2.scatter(np.arange(len(Numba_m)), new_m, label='XFTA', marker='v', c='red', s=80)
# ax2.scatter(np.arange(len(Numba_m)), SAPHSOLVE_m, marker='v', c='black', s=80)
ax2.scatter(np.arange(len(Numba_m)), ScramB_m,label='SCRAM - BDD', marker='v', c='green', s=80)
ax2.scatter(np.arange(len(Numba_m)), ScramM_m, label='SCRAM - MOCUS', marker='v', c='blue', s=80)
ax2.scatter(np.arange(len(Numba_m)), ScramR_m, label='SCRAM - ZBDD',marker='v', c='magenta', s=80)

ax2.set_ylabel('Memory [MB]', fontsize=12,  weight='bold')
